    ...
    <header className="flex justify-between items-center px-4 bg-white shadow-md">
      ...
      <div className="flex items-center">
        ...
        <h1 className="text-2xl font-bold text-orange-600">
          Rohit's Food Delivery
        </h1>
        <h1 className="hover:text-orange-500 text-sm font-bold text-black pl-6">
          Other
        </h1>
        <h1 className="hover:text-orange-500 text-sm font-light text-gray-500 pl-1 hover:cursor-pointer">
      ...
      <nav>
        <ul className="flex space-x-8 font-medium text-gray-700">
          ...
          <li>
            <div
              className="flex"
              onClick={() => setUserName("Rohit (Founder)")}
            >
              <img alt="cart-img" src={cardIconUrl} className="h-7 w-7 mr-2" />
              <Link
                to="/contact"
          ...
          <li>
            <div className="flex">
              ...
              <Link
                to="/cart"
                className="hover:text-orange-500 transition duration-300 mr-0.5"
              >
                Cart
              </Link> 
